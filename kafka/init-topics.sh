...
TOPICS=("${KAFKA_TOPIC_PRODUCTS:-shopify.products}" "${KAFKA_TOPIC_INVENTORY:-shopify.inventory}" "${KAFKA_TOPIC_ORDER_DETAILS:-shopify.order_details}" "${KAFKA_TOPIC_CUSTOMERS:-shopify.customers}")
